...
export default function PortfolioPage(): JSX.Element {
  return (
    <main className="min-h-screen bg-[var(--bg)] dark:bg-[var(--bg)]">
              ...
              <Reveal delayMs={240}>
                <div className="bg-[#1e293b] dark:bg-[#1e293b] border border-slate-600 dark:border-slate-600 rounded-3xl p-6 sm:p-8 lg:p-10 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:border-emerald-500 dark:hover:border-emerald-500 cursor-pointer group relative overflow-hidden">
                  ...
                  <div className="flex items-center gap-4 sm:gap-6 mb-6">
                    <div className="w-12 h-12 sm:w-16 sm:h-16 lg:w-20 lg:h-20 bg-gradient-to-br from-[var(--accent)] to-[var(--accent-2)] rounded-2xl flex items-center justify-center text-white font-bold text-lg sm:text-xl lg:text-2xl shadow-lg transition-transform duration-300 group-hover:scale-110">
                      FB
                    </div>
                    <div>
            ...
            <div className="flex flex-col justify-center items-start lg:items-start text-center lg:text-left">
              ...
              <Reveal delayMs={600}>
                <div className="bg-[#1e293b] dark:bg-[#1e293b] border border-slate-600 dark:border-slate-600 rounded-3xl p-8 sm:p-10 lg:p-12 backdrop-blur-20 shadow-2xl relative overflow-hidden">
                  <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-[var(--accent)] to-[var(--accent-2)] opacity-80"></div>
      ...
      {/* CTA Section */}
      <section className="py-16 sm:py-20 lg:py-24 bg-[var(--bg-elev)] dark:bg-[var(--bg-elev)] text-center">
        <div className="container mx-auto px-4">
