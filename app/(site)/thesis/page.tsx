    ...
    >
              ...
              >
                <div>
                  ...
                  <div className="flex gap-4 mt-5 flex-wrap">
                    <div
                      className="flex items-center justify-center gap-2 px-3 py-2 rounded-xl border transition-all duration-300 hover:bg-emerald-100/10 hover:border-emerald-300/30 hover:-translate-y-0.5"
                      style={{
                        background: "rgba(255, 255, 255, 0.05)",
                        borderColor: "rgba(255, 255, 255, 0.1)",
                      }}
            ...
            <Reveal delayMs={600}>
              ...
              >
                <div className="relative z-10">
                  ...
                  <div className="flex items-center justify-center mt-4 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-blue-200 dark:border-blue-700/30 text-center">
      ...
      >
        <div
          ...
          style={{ backgroundImage: "url('/assets/Map - africa 2.jpg')" }}
        ></div>
