...
export default function Footer() {
  return (
    <footer className="bg-[#C9A227] text-white py-16 mt-16 md:mt-24">
        ...
        <div className="grid md:grid-cols-3 gap-12 md:gap-8">
          <div className="space-y-4">
            ...
            <a
              ...
              className="inline-block px-6 py-2.5 rounded-full bg-white text-gray-600 font-medium text-sm transition-all duration-300 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-[#C9A227] cursor-pointer"
            >
              Email Us
            </a>
          </div>
