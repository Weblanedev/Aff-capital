...
import { AFF_ICONS, AFF_PHOTOS } from "../lib/assets";
        ...
        <div className="animate-fade-in-up">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 mb-16">
            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="bg-white/5 border border-white/10 rounded-2xl p-8 transition-all duration-300 hover:-translate-y-2 hover:border-white/20 hover:shadow-2xl backdrop-blur-sm">
                <div className="mb-5 flex justify-center lg:justify-start">
                  <AffIcon src={AFF_ICONS.banking} alt="" size={48} />
                </div>
                <h3 className="text-2xl lg:text-3xl font-bold text-[var(--text)] mb-4 leading-tight text-center lg:text-left">
            ...
            <div className="flex flex-col gap-10">
              <div className="relative min-h-[280px] sm:min-h-[320px] flex items-center justify-center overflow-hidden rounded-2xl">
                <ImageWithSkeleton
                  src={AFF_PHOTOS.about}
                  alt="African founders"
                  fill
                ...
                <div
                  className="absolute top-5 left-5 bg-white/10 border border-white/10 rounded-2xl p-5 backdrop-blur-sm transition-all duration-400 hover:scale-105 hover:border-white/20 z-20"
                  style={{
                    animation: "float 6s ease-in-out infinite",
                    animationDelay: "0s",
                  }}
                >
                  <AffIcon src={AFF_ICONS.payments} alt="" size={32} className="mb-3" />
                  <div>
                ...
                >
                  <AffIcon src={AFF_ICONS.banking} alt="" size={32} className="mb-3" />
                  <div>
                    <h4 className="text-lg font-semibold mb-2 text-[var(--text)]">
                      Partnership
                    </h4>
